...
>(({ className, ...props }, ref) => (
	<TabsPrimitive.Trigger
		...
		className={cn(
			...
			'bg-[#F1F2F4] dark:bg-[#272c36] text-primary dark:text-white',
			'data-[state=active]:bg-accent dark:data-[state=active]:bg-accent dark:data-[state=active]:text-primary data-[state=active]:font-bold data-[state=active]:shadow-sm',
			className
		)}
		{...props}
	/>
